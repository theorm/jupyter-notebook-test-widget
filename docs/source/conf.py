...
# -*- coding: utf-8 -*-
#
# rk_test_widget documentation build configuration file
#
...
project = 'rk_test_widget'
copyright = '2021, Roman K'
author = 'Roman K'
...
_version_py = os.path.join(repo, 'rk_test_widget', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'rk_test_widgetdoc'
...
latex_documents = [
    (master_doc, 'rk_test_widget.tex', 'rk_test_widget Documentation',
     'Roman K', 'manual'),
]
